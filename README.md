...
### 🔗 Интеграции
- **Paperless-NGX** - Автоматическая синхронизация с системой управления документами
- **Paperless-AI** - Умное тегирование документов с помощью AI
- **1C ERP** - Интеграция с корпоративными системами учета
- **Расширяемая система плагинов** для добавления новых интеграций
...
1. **Настройте подключение:**
   - Перейдите в **Настройки → Интеграция с Paperless-NGX**
   - Введите URL сервера и API токен
   - Протестируйте подключение

2. **Синхронизируйте документы:**
   - **Текущий документ** - после обработки нажмите "Синхронизировать"
   - **Массовая синхронизация** - для всех обработанных документов

3. **Используйте AI тегирование:**
   - Включите автоматическое тегирование
   - Создайте кастомные правила
   - Анализируйте статистику

📖 **Подробнее:** см. [PAPERLESS_USER_GUIDE.md](PAPERLESS_USER_GUIDE.md)
...
### 📖 Быстрые ссылки:
- 🚀 **[Быстрый старт](docs/user-guides/QUICK_START_INTEGRATIONS.md)** - Начните отсюда!
- 📄 **[Руководство по Paperless](docs/user-guides/PAPERLESS_USER_GUIDE.md)** - Интеграция с Paperless-NGX
- 💻 **[Примеры интеграций](docs/user-guides/INTEGRATION_EXAMPLES.md)** - Примеры кода
- 🔌 **[Система плагинов](docs/features/PLUGIN_SYSTEM_GUIDE.md)** - Разработка плагинов
- 🏗️ **[Архитектура системы](docs/architecture/SYSTEM_ARCHITECTURE_ANALYSIS.md)** - Для разработчиков
